...
✅ 1. Vérifier le périphérique audio par défaut
Sur Windows :
1. Clic droit sur l’icône du son
2. Paramètres audio
3. Vérifier :
...
✅ 2. Désactiver les périphériques audio inutiles
Toujours dans les paramètres audio → Gérer les périphériques audio :
- désactiver les sorties HDMI inutiles
- désactiver les casques Bluetooth non connectés
- désactiver les drivers virtuels (VB-Audio, etc.)
PyGame peut se tromper de périphérique si plusieurs sont actifs.
...
2. “Contrôleurs audio, vidéo et jeu”
3. Clic droit → Désinstaller
4. Redémarrer → Windows réinstalle automatiquement
